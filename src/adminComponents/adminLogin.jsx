...
export default function AdminLogin() {
  ...
  function handleSubmit(e) {
    ...
    setSubmitting(true);
    // TODO: wire to the real admin-auth endpoint once it exists.
    setTimeout(() => setSubmitting(false), 900);
  }

  return (
    <div className="sp-root admin-login-page" data-theme={theme}>
      {/* ===== LEFT INFO PANEL ===== */}
      <div className="info-panel">
        ...
        <div className="info-mid">
          <span className="badge-pill"><span className="dot"></span> Admin Console</span>
          <h1>
            Welcome back,
            <span className="accent">Administrator</span>
          </h1>
          <p>Manage courses, examinations, notifications and student records — all in one place.</p>
          ...
          <div className="feature-list">
            <div className="feature-item">
              ...
              <span>Manage CMS menus and page content</span>
            </div>
            <div className="feature-item">
              <div className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2"><path d="M3 8 12 4l9 4-9 4-9-4Z"></path><path d="M7 10v5c0 1.5 2.2 3 5 3s5-1.5 5-3v-5"></path></svg></div>
              <span>Review registrations and applications</span>
            </div>
            <div className="feature-item">
              ...
              <span>Publish results, notices and certificates</span>
            </div>
          </div>
        </div>

        <div className="live-users"><span className="pulse"></span> 4 admins currently logged in</div>
      </div>
      ...
      <div className="form-panel">
        <div className="form-wrap">
          ...
          <p className="sub">Enter your administrator credentials to continue.</p>
          ...
          <div className="divider">Not an admin?</div>

          <div className="new-user-box">
            <p>Admin accounts are provisioned by the system administrator — self-registration isn't available.</p>
